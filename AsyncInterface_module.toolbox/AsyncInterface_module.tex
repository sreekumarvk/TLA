...
\setboolean{shading}{true}
 ...
 AsyncInterface\_module}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals}%
\@x{ {\CONSTANT} Data}%
\@x{ {\VARIABLE} chan}%
\@pvspace{8.0pt}%
...
\@x{ Send ( d ) \.{\defeq} \.{\land} chan . rdy \.{=} chan . ack}%
 ...
 \.{=} d ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
\@x{ Recv \.{\defeq} \.{\land} chan . rdy\@s{0.23} \.{\neq} chan . ack}%
 \@x{\@s{29.34} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . ack
 \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
 \@x{ Next\@s{0.20} \.{\defeq} ( \E\, d \.{\in} Data \.{:} Send ( d ) )
 \.{\lor} Recv}%
\@pvspace{8.0pt}%
\@x{ Spec\@s{1.67} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ chan}}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 27 12:14:04 \ensuremath{PST} 2014 by \ensuremath{svkodaka
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Nov} 27
 11:53:57 \ensuremath{PST} 2014 by \ensuremath{svkodaka
}%
\end{cpar}%
\end{lcom}%
\end{document}
